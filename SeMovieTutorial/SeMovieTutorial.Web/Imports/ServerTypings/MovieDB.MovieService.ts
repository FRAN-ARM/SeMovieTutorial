namespace SeMovieTutorial.MovieDB {
    export namespace MovieService {
        ...
        export declare function List(request: MovieDB.Repositories.MovieListRequest, onSuccess?: (response: Serenity.ListResponse<MovieRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
