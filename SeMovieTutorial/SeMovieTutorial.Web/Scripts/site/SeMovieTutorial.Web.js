...
(function (SeMovieTutorial) {
    ...
    })(Administration = SeMovieTutorial.Administration || (SeMovieTutorial.Administration = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Administration;
    (function (Administration) {
...
(function (SeMovieTutorial) {
    ...
    })(BasicSamples = SeMovieTutorial.BasicSamples || (SeMovieTutorial.BasicSamples = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SeMovieTutorial.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SeMovieTutorial.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SeMovieTutorial.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SeMovieTutorial) {
    ...
    })(Common = SeMovieTutorial.Common || (SeMovieTutorial.Common = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Common;
...
(function (SeMovieTutorial) {
    ...
    })(Membership = SeMovieTutorial.Membership || (SeMovieTutorial.Membership = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Membership;
    ...
    (function (Modules) {
        ...
        (function (MovieDB) {
            ...
            (function (PersonGender) {
                ...
                Serenity.Decorators.registerEnumType(Gender, 'SeMovieTutorial.Modules.MovieDB.PersonGender.Gender', 'MovieDB.Gender');
            })(PersonGender = MovieDB.PersonGender || (MovieDB.PersonGender = {}));
        })(MovieDB = Modules.MovieDB || (Modules.MovieDB = {}));
    })(Modules = SeMovieTutorial.Modules || (SeMovieTutorial.Modules = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var MovieDB;
    ...
    })(MovieDB = SeMovieTutorial.MovieDB || (SeMovieTutorial.MovieDB = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var MovieDB;
...
(function (SeMovieTutorial) {
    ...
    })(Northwind = SeMovieTutorial.Northwind || (SeMovieTutorial.Northwind = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Northwind;
...
(function (SeMovieTutorial) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SeMovieTutorial.Northwind.Gender', 'SeMovieTutorial.Northwind.Entities.Gender');
    })(Northwind = SeMovieTutorial.Northwind || (SeMovieTutorial.Northwind = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
...
(function (SeMovieTutorial) {
    ...
    })(Authorization = SeMovieTutorial.Authorization || (SeMovieTutorial.Authorization = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Administration;
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SeMovieTutorial.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SeMovieTutorial.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SeMovieTutorial.Common.ReportHelper.execute({
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SeMovieTutorial.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SeMovieTutorial.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SeMovieTutorial.Northwind.OrderDialog();
                        ...
                        var chai = SeMovieTutorial.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SeMovieTutorial.Northwind.EmployeeRow.getLookup().items
        ...
        }(SeMovieTutorial.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SeMovieTutorial.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.OrderDialog));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SeMovieTutorial.Northwind.CategoryService.Retrieve({
        ...
        }(SeMovieTutorial.Northwind.CategoryDialog));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SeMovieTutorial.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SeMovieTutorial.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SeMovieTutorial.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SeMovieTutorial.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SeMovieTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SeMovieTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SeMovieTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SeMovieTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SeMovieTutorial.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SeMovieTutorial.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return SeMovieTutorial.LanguageList.getValue();
            };
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.SupplierDialog));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SeMovieTutorial.Northwind.SupplierGrid));
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SeMovieTutorial.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SeMovieTutorial.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SeMovieTutorial.Northwind.CustomerDialog));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.CustomerGrid));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SeMovieTutorial.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SeMovieTutorial.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SeMovieTutorial.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SeMovieTutorial.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SeMovieTutorial.Northwind.OrderDetailDialog));
...
(function (SeMovieTutorial) {
    ...
    (function (Northwind) {
        ...
        }(SeMovieTutorial.Common.GridEditorBase));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Northwind.OrderDetailsEditor));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SeMovieTutorial.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SeMovieTutorial.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SeMovieTutorial.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SeMovieTutorial.BasicProgressDialog();
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SeMovieTutorial.Common.BulkServiceAction));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SeMovieTutorial.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SeMovieTutorial.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SeMovieTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SeMovieTutorial.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SeMovieTutorial.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SeMovieTutorial.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SeMovieTutorial) {
    ...
    SeMovieTutorial.SelectableEntityGrid = SelectableEntityGrid;
})(SeMovieTutorial || (SeMovieTutorial = {}));
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SeMovieTutorial.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SeMovieTutorial.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SeMovieTutorial.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SeMovieTutorial.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SeMovieTutorial.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SeMovieTutorial.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SeMovieTutorial.Northwind.ProductService.baseUrl; };
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SeMovieTutorial.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SeMovieTutorial.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SeMovieTutorial.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SeMovieTutorial.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SeMovieTutorial) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SeMovieTutorial.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SeMovieTutorial.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SeMovieTutorial.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SeMovieTutorial) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SeMovieTutorial.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SeMovieTutorial.LanguageList || (SeMovieTutorial.LanguageList = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
...
(function (SeMovieTutorial) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SeMovieTutorial.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SeMovieTutorial.ScriptInitialization || (SeMovieTutorial.ScriptInitialization = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    ...
    SeMovieTutorial.BasicProgressDialog = BasicProgressDialog;
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var DialogUtils;
    ...
    })(DialogUtils = SeMovieTutorial.DialogUtils || (SeMovieTutorial.DialogUtils = {}));
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Common;
...
(function (SeMovieTutorial) {
    ...
    SeMovieTutorial.StaticTextBlock = StaticTextBlock;
})(SeMovieTutorial || (SeMovieTutorial = {}));
var SeMovieTutorial;
(function (SeMovieTutorial) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SeMovieTutorial.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=SeMovieTutorial.Web.js.map